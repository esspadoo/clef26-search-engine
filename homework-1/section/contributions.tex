...
\begin{description}
    ...
    \begin{enumerate}
        \item Helping designing and implementing the initial BM25 basic pipeline;
        \item Implementing a BooleanQuery-based parsing in `Searcher.java` to separate the original tweet and expanded terms into different clauses with tailored boosts (and applying field filters for venue/authors), improving retrieval precision;
        \item Implementing and testing the multilingual query-expansion pipeline (e.g. `query_expansion_multilingual.py`, tested with `PROVEDAVIDE.py`) and fixing issues found during integration;
    ...
    \begin{enumerate}
        ...
        \item Writing and revising parts of the documentation, especially the introduction, related work, results, conclusion, and setup sections, with appropriate academic references.
    \end{enumerate}
