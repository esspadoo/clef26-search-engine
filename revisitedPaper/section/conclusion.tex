...
First, investing more time in analysis and fine-tuning of the reranker and all other components of the system would probably bring better results. Many techniques, such as data augmentation can be experimented with, and there is room for improvement.
