...
First, analyzing and spending more time for a better fine-tuning of the reranker and all other components of the system could bring better results. A lot of techniques like data augmentation can be experimented and there is room for improvement.
