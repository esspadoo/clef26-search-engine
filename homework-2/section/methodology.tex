...
Before settling on this query expansion strategy, we also tried two LLM models, \texttt{meta-llama/Llama-3.2-1B} and \texttt{openai/gpt-oss-20b}, with the following prompt:
\begin{promptbox}
    \small
    \ttfamily
    \begin{flushleft}
