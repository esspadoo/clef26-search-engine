...
\begin{enumerate}
    ...
    \item The expanded queries are fed into \texttt{BAAI/bge-m3} \cite{bge-m3} operating in hybrid mode, which combines dense inner-product search via FAISS \cite{faiss_documentation} with sparse lexical matching and ColBERT multi-vector scoring to produce an initial ranked list of candidates.
