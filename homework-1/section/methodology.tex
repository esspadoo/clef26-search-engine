...
\]
\end{itemize}
The final expanded query is constructed by concatenating three components: the cleaned translated query, the noun- and proper-noun-based keyword set extracted directly from the query, and the expansion terms induced from the retrieved document neighborhood.
