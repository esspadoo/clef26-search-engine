    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (rerankedPath != null) {
                ...
                // Salva i risultati BM25 in JSON (input per Reranker.py)
            ...
            // 2. Stampa i top risultati (opzionale, utile per debug)
            /*
            int printed = 0;
            ...
            */
            ...
            // 3. Configurazione (aggiornata per riflettere il re-ranking)
