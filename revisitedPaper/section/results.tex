...
\begin{table*}[htbp]
    \centering
    \footnotesize
    \caption{Runs comparison on the final\_en\_test.json set. They are all based on  bi513\_encoder\_results\_bge\_large\_topk1000 to be more explicative, FT stands for fine-tuned.}\label{tab:TEST-run-comparison}
    \resizebox{\textwidth}{!}{%
