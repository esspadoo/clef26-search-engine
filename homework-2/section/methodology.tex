...
Some rerankers have been tested: Qwen/Qwen3-Reranker-4B \cite{qwen3embedding}, Alibaba-NLP/gte-reranker-modernbert-base \cite{zhang2024mgte, li2023towards} and nvidia/llama-nemotron-rerank-1b-v2\cite{llama-nemotron-rerank-1b-v2}.
