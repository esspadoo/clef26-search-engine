...
\begin{enumerate}
    ...
    \item Finally, the top candidates are re-ranked by a neural cross-encoder, in our case nvidia/llama-nemotron-rerank-1b-v2 \cite{nvidia_llama_nemotron_rerank_1b_v2_2026}, fine-tuned on the English training dataset of the CLEF CheckThat! Task 1 2026 and all the queries' datasets of the  CLEF CheckThat! SubTask 4b 2025.
\end{enumerate}  
