...
\begin{table}[htbp]
	...
	\begin{tabular}{l l l r r r r r r}
		...
		& \textbf{32409} & & \textbf{2} & \textbf{33} & \textbf{60} & \textbf{31.6} \\
...
Figure \ref{fig:query_token_length_distribution} compares the distribution of token lengths across train, dev and test datasets. All three datasets share similar distributions, with the same median value and similar length value peaks.
\\
\\
\\
\\
